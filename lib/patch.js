 ...
 * @property {Array} revert  - A JSON Patch to revert the original patch
 */
 ...
 * @param  {Boolean}      options.reversible  - return a JSON Patch to revert the operation
 * @return {PatchResult}
 */
